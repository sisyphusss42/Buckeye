...
var CognitoUser = function() {
  ...
  _proto.updateAttributes = function updateAttributes(attributes, callback, clientMetadata) {
    ...
    this.client.request("UpdateUserAttributes", {
      ...
      return _this0.getUserData(function() {
  ...
  _proto.refreshSessionIfPossible = function refreshSessionIfPossible(options) {
    ...
    return new Promise(function(resolve) {
      var refresh = _this1.signInUserSession.getRefreshToken();
      if (refresh && refresh.getToken()) {
        _this1.refreshSession(refresh, resolve, options.clientMetadata);
      } else {
        resolve();
      }
    });
  ...
  _proto.getUserData = function getUserData(callback, params) {
    ...
    if (this.isFetchUserDataAndTokenRequired(params)) {
      this.fetchUserData().then(function(data) {
        return _this10.refreshSessionIfPossible(params).then(function() {
          return data;
        });
      }).then(function(data) {
  ...
  _proto.deleteAttributes = function deleteAttributes(attributeList, callback) {
    ...
    this.client.request("DeleteUserAttributes", {
      ...
      return _this12.getUserData(function() {
        return callback(null, "SUCCESS");
      }, {
        bypassCache: true
      });
  ...
  _proto.refreshSession = function refreshSession(refreshToken, callback, clientMetadata) {
    ...
    this.client.requestWithRetry("InitiateAuth", jsonReq, function(err, authResult) {
      ...
      if (authResult) {
        ...
        _this13.signInUserSession = _this13.getCognitoUserSession(authenticationResult);
        _this13.cacheTokens();
        return wrappedCallback(null, _this13.signInUserSession);
      }
      return void 0;
    });
  };
  ...
  _proto.forgetDevice = function forgetDevice(callback) {
    ...
    this.forgetSpecificDevice(this.deviceKey, {
      ...
      onSuccess: function onSuccess(result) {
        _this14.deviceKey = null;
        _this14.deviceGroupKey = null;
        _this14.randomPassword = null;
        _this14.clearCachedDeviceKeyAndPassword();
  ...
  _proto.signOut = function signOut(revokeTokenCallback) {
    ...
    this.getSession(function(error, _session) {
      ...
      _this16.revokeTokens(function(err) {
        _this16.cleanClientData();
